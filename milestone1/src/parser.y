...
%type<node> parameters typedargslist expr_star_expr 
...
int main(int argc, char* argv[]) {
    /* yybye = 1; */
    if (argc < 3) {
        cout << "Usage: " << argv[0] << " provide both input and output files " << endl;
        return 1;
    }
    extern FILE* yyin;
